...
const file_proto_user_proto_rawDesc = "" +
	...
	"\aprofile\x18\x01 \x01(\v2\r.user.ProfileR\aprofile2\x8d\x01\n" +
	"\vUserService\x12;\n" +
	"\bGetUsers\x12\x15.user.GetUsersRequest\x1a\x16.user.GetUsersResponse\"\x00\x12A\n" +
	"\n" +
	"GetProfile\x12\x17.user.GetProfileRequest\x1a\x18.user.GetProfileResponse\"\x00B7Z5github.com/CpBruceMeena/golang-nexuspoint/proto/protob\x06proto3"
...
var file_proto_user_proto_depIdxs = []int32{
	...
	1, // 1: user.GetProfileResponse.profile:type_name -> user.Profile
